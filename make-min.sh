...
# minify core lib
java -jar ${CLOSURECOMPILER} --compilation_level ADVANCED_OPTIMIZATIONS --js src/core/_minify.js ./build/melown-core-v1-merge-tmp.js --js_output_file ./build/melown-core-v1-tmp.js
 cat ./build/license-tmp.js \
     src/core/utils/libs/proj4.js \
     src/core/utils/libs/geographics-nomini.js \
...
# merge melown 
cat src/browser/utility/utility.js \
    ...
    src/browser/interface.js > ./build/melown-v1-plain.js
...
cat ./build/license-tmp.js \
    ...
    src/core/utils/libs/geographics-nomini.js \
    src/core/_nominify.js \
    ./build/melown-core-v1-merge-tmp.js \
    ./build/melown-v1-plain.js > ./build/melown-browser.js

#minify lib
 java -jar ${CLOSURECOMPILER} --compilation_level ADVANCED_OPTIMIZATIONS --js src/core/_minify.js ./build/melown-core-v1-merge-tmp.js ./build/melown-v1-plain.js --js_output_file ./build/melown-v1-tmp.js
 cat ./build/license-tmp.js \
     src/core/utils/libs/proj4.js \
     src/core/utils/libs/geographics-nomini.js \
     ./build/melown-v1-tmp.js > ./build/melown-v1-min.js
...
cp ./build/melown-browser.css ./build/melown-browser.min.css 
mv ./build/melown-v1-merge.js ./build/melown-browser.js 
mv ./build/melown-core-v1-merge.js ./build/melown-core.js
mv ./build/melown-core-v1-inspector-mini.js ./build/melown-core.min.js
mv ./build/melown-v1-min.js ./build/melown-browser.min.js
...
rm ./build/geodata-worker-tmp.js
rm ./build/license-tmp.js
rm ./build/melown-core-v1-merge.js
rm ./build/melown-core-v1-merge-tmp.js
rm ./build/melown-core-v1-merge-tmp.js
rm ./build/melown-v1-plain.js
rm ./build/melown-v1-tmp.js

echo "------------------------------------------------"
echo "  update browser and core VERSION !!!!"
echo "------------------------------------------------"
