...
function Point(x, y, z) {
  ...
  console.warn('_mproj4_.Point will be removed in version 3, use _mproj4_.toPoint');
}
...
},{"mgrs":68}],2:[function(_dereq_,module,exports){
...
module.exports = _mproj4_;
},{"./Proj":2,"./transform":66}],30:[function(_dereq_,module,exports){
var HALF_PI = Math.PI/2;
var PJD_3PARAM = 1;
var PJD_7PARAM = 2;
var PJD_GRIDSHIFT = 3;
...
},{"./global":35,"./projString":38,"./wkt":67}],33:[function(_dereq_,module,exports){
...
var _mproj4_ = _dereq_('./core');
_mproj4_.defaultDatum = 'WGS84'; //default datum
_mproj4_.Proj = _dereq_('./Proj');
_mproj4_.WGS84 = new _mproj4_.Proj('WGS84');
_mproj4_.Point = _dereq_('./Point');
_mproj4_.toPoint = _dereq_("./common/toPoint");
_mproj4_.defs = _dereq_('./defs');
_mproj4_.transform = _dereq_('./transform');
_mproj4_.mgrs = _dereq_('mgrs');
_mproj4_.version = _dereq_('../package.json').version;
_dereq_('./includedProjections')(_mproj4_);
module.exports = _mproj4_;
},{"../package.json":69,"./Point":1,"./Proj":2,"./common/toPoint":23,"./core":29,"./defs":32,"./includedProjections":"Pk/iAZ","./transform":66,"mgrs":68}],37:[function(_dereq_,module,exports){
...
},{"./defs":32,"./projString":38,"./wkt":67}],38:[function(_dereq_,module,exports){
...
},{"./projections/longlat":52,"./projections/merc":53}],40:[function(_dereq_,module,exports){
var EPSLN = 1.0e-10;
...
},{"../common/adjust_lon":5,"../common/asinz":6}],49:[function(_dereq_,module,exports){
var adjust_lon = _dereq_('../common/adjust_lon');
exports.init = function() {
  this.a = 6377397.155;
...
},{"../common/adjust_lon":5}],50:[function(_dereq_,module,exports){
var HALF_PI = Math.PI/2;
var FORTPI = Math.PI/4;
var EPSLN = 1.0e-10;
var qsfnz = _dereq_('../common/qsfnz');
...
},{"../common/adjust_lon":5,"../common/qsfnz":20}],51:[function(_dereq_,module,exports){
var EPSLN = 1.0e-10;
var msfnz = _dereq_('../common/msfnz');
...
},{"../common/adjust_lon":5,"../common/msfnz":15,"../common/phi2z":16,"../common/sign":21,"../common/tsfnz":24}],52:[function(_dereq_,module,exports){
exports.init = function() {
  //no-op for longlat
};
...
},{"../common/adjust_lon":5,"../common/msfnz":15,"../common/phi2z":16,"../common/tsfnz":24}],54:[function(_dereq_,module,exports){
var adjust_lon = _dereq_('../common/adjust_lon');
/*
  reference
    "New Equal-Area Map Projections for Noncircular Regions", John P. Snyder,
...
},{"../common/adjust_lon":5}],56:[function(_dereq_,module,exports){
var SEC_TO_RAD = 4.84813681109535993589914102357e-6;
/*
  reference
...
},{"../common/adjust_lon":5,"../common/phi2z":16,"../common/tsfnz":24}],58:[function(_dereq_,module,exports){
var e0fn = _dereq_('../common/e0fn');
var e1fn = _dereq_('../common/e1fn');
var e2fn = _dereq_('../common/e2fn');
var e3fn = _dereq_('../common/e3fn');
...
},{"../common/adjust_lat":4,"../common/adjust_lon":5,"../common/e0fn":7,"../common/e1fn":8,"../common/e2fn":9,"../common/e3fn":10,"../common/gN":11,"../common/mlfn":14}],59:[function(_dereq_,module,exports){
var adjust_lon = _dereq_('../common/adjust_lon');
var adjust_lat = _dereq_('../common/adjust_lat');
...
},{"../common/adjust_lat":4,"../common/adjust_lon":5,"../common/asinz":6,"../common/pj_enfn":17,"../common/pj_inv_mlfn":18,"../common/pj_mlfn":19}],60:[function(_dereq_,module,exports){
/*
  references:
...
},{"../common/adjust_lon":5,"../common/msfnz":15,"../common/phi2z":16,"../common/sign":21,"../common/tsfnz":24}],62:[function(_dereq_,module,exports){
...
},{"../common/adjust_lon":5,"./gauss":46}],63:[function(_dereq_,module,exports){
var e0fn = _dereq_('../common/e0fn');
var e1fn = _dereq_('../common/e1fn');
var e2fn = _dereq_('../common/e2fn');
var e3fn = _dereq_('../common/e3fn');
...
},{"../common/adjust_lon":5,"../common/asinz":6,"../common/e0fn":7,"../common/e1fn":8,"../common/e2fn":9,"../common/e3fn":10,"../common/mlfn":14,"../common/sign":21}],64:[function(_dereq_,module,exports){
var D2R = 0.01745329251994329577;
...
},{"./tmerc":63}],65:[function(_dereq_,module,exports){
var adjust_lon = _dereq_('../common/adjust_lon');
var HALF_PI = Math.PI/2;
var EPSLN = 1.0e-10;
var asinz = _dereq_('../common/asinz');
...
},{"../common/adjust_lon":5,"../common/asinz":6}],66:[function(_dereq_,module,exports){
var D2R = 0.01745329251994329577;
var R2D = 57.29577951308232088;
var PJD_3PARAM = 1;
var PJD_7PARAM = 2;
...
module.exports = function transform(source, dest, point) {
  ...
  if (source.projName === "longlat") {
    ...
    if (source.isGeocent) {
      ...
      dest.datum.geocentric_to_geodetic_noniter(point);
      //dest.datum.geocentric_to_geodetic(point);
    } else {
      if (source.to_meter) {
        point.x *= source.to_meter;
        point.y *= source.to_meter;
  ...
  if (dest.projName === "longlat") {
    ...
    if (dest.isGeocent) {
      dest.datum.geodetic_to_geocentric(point);
      if (dest.to_meter) {
...
},{"./Proj":2,"./adjust_axis":3,"./common/toPoint":23,"./datum_transform":31}],67:[function(_dereq_,module,exports){
var D2R = 0.01745329251994329577;
var extend = _dereq_('./extend');
...
},{"./extend":34}],68:[function(_dereq_,module,exports){
...
module.exports={
  ...
  "repository": {
    "type": "git",
    "url": "git://github.com/_mproj4_js/_mproj4_js.git"
  },
  "author": "",
  "license": "MIT",
  "jam": {
    "main": "dist/_mproj4_.js",
    "include": [
      "dist/_mproj4_.js",
      "README.md",
      "AUTHORS",
...
module.exports=_dereq_('Pk/iAZ');
},{}],"Pk/iAZ":[function(_dereq_,module,exports){
var projs = [
