...
RendererInit.prototype.initShaders = function() {
    ...
    renderer.progELine = new GpuProgram(gpu, shaders.elineVertexShader, shaders.elineFragmentShader);
    renderer.progLine3 = new GpuProgram(gpu, shaders.line3VertexShader, shaders.line3FragmentShader);
    renderer.progELine3 = new GpuProgram(gpu, shaders.eline3VertexShader, shaders.elineFragmentShader);
    ...
    renderer.progETLine = new GpuProgram(gpu, shaders.etlineVertexShader, shaders.elineFragmentShader);
    renderer.progETPLine = new GpuProgram(gpu, shaders.etplineVertexShader, shaders.elineFragmentShader);
